...
from hermes_cli.subcommands.build import build_build_parser
...
def cmd_build(args):
    """Universal Multi-Agent Builder entrypoint."""
    from hermes_cli.subcommands.build import _run_build
...
def main():
    ...
    # =========================================================================
    # build command — Universal Multi-Agent Builder
    # =========================================================================
    build_build_parser(subparsers, cmd_build=cmd_build)
